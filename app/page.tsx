...
export default function Dashboard() {
  ...
  // Helper to fetch data with local and session caching
                  ...
                  <div className="bg-card rounded-xl p-8 sm:p-10 hover:shadow-lg transition-all duration-200 sketchbook-paper">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                      ...
                      <div className="flex flex-col sm:flex-row items-end sm:items-center gap-2 sm:gap-4">
                        <span className="text-[10px] text-muted-foreground font-sans uppercase tracking-[0.2em] opacity-70">All in UTC +3</span>
